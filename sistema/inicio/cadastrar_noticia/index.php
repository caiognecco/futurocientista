<?php
//SISTEMA/INICIO/CADASTRAR_NOTICIA

$titulo = "Cadastrar Not&iacute;cia";
        ...
        <tbody>
            ...
            <tr>
                <td colspan="2"><p align="center" class="Chamada1">
                        <i class="fa fa-newspaper-o fa-1x"></i> Cadastrar Not&iacute;cia
                </td>
            </tr>
            <tr><td>
                    <br>
            ...
            <textarea rows="8" name="noticia">Not&iacute;cia</textarea> <br><br>
