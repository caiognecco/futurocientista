...
<div id="corpo" style="overflow: hidden; width: 100%; padding-bottom: 5%;">
    ...
    <div style="overflow: hidden; width: 70%; margin-left: auto; margin-right: auto; margin-top: 1%;" align="center">
        ...
        <div style="overflow: hidden; width: 70%">
            <p style="font-size: 1.2em;">Os adolescentes da unidade de Sorocaba das Casas Lares Bethel t&#234;m a oportunidade de mergulhar no mundo da Ci&#234;ncia por meio do PFC. Eles participam das mesmas atividades dos n&#250;cleos escolares, com aten&#231;&#227;o especial para que consigam vencer seus desafios.
    ...
    <div style="overflow: hidden; width: 70%; margin-left: auto; margin-right: auto; margin-top: 2%;" align="center">
        ...
        <div style="width: 70%; overflow: hidden;">
            <p style="font-size: 1.2em;">Esse &#233; o grande evento do PFC, onde os resultados de um ano inteiro de trabalho s&#227;o apresentados, tal como em uma feira de ci&#234;ncias. &#201; um dia que os alunos de todos os N&#250;cleos de Desenvolvimento Cient&#237;fico (NDCs), de todas as cidades participantes, compartilham suas descobertas, al&#233;m de serem avaliados por profissionais para concorrerem aos pr&#234;mios finais.
                <br>Neste dia s&#227;o premiados os melhores projetos cient&#237;ficos, divididos por etapas de ensino e cidades; e tamb&#233;m os melhores textos do Concurso Literario e as maiores pontua&#231;&#245;es da Maratona do Conhecimento.
                <div style="font-size: 1.2em; text-align: left;">
                <strong>P&#250;blico:</strong> todos os alunos conveniados ao Programa, do Ensino Fundamental II e Ensino M&#233;dio, com idade entre 12 e 18 anos.
                <br>
    ...
    <div style=" overflow: hidden; width: 70%; margin-left: auto; margin-right: auto; margin-top: 2%;" align="center">
        ...
        <div style="width: 70%;">
            <p style="font-size: 1.2em;">Para que os alunos do PFC tivessem melhores condições de se preparar para o Vestibular, o programa fez uma parceria com o Colégio Objetivo de Sorocaba, que cedeu espaço para aulas e material didático, para a realização do Cursinho Talentos do Futuro. Os professores eram alunos do último ano de graduação e alunos do Mestrado da Ufscar, que deram aulas voluntárias: <br>
            ...
            <span style="color: red; font-weight: bolder;">*</span> Neste ano são poucos os alunos vestibulandos no PFC, residentes em cidades diferentes, por isso o cursinho não será realizado. Parcerias para bolsas em cursinhos locais estão sendo articuladas.
    ...
    <div style=" overflow: hidden; width: 70%; margin-left: auto; margin-right: auto; margin-top: 2%;" align="center">
        ...
        <div style="width: 70%; position:relative; top: 5px;">
            <p style="font-size: 1.2em;">Alunos da gradua&#231;&#227;o em Biologia da Ufscar produzem v&#237;deos sobre temas cient&#237;ficos, voluntariamente. S&#227;o tr&#234;s minutos de conte&#250;do apresentado em forma de desenhos, que servem de material de apoio para os aprendizados.
            <div style="font-size: 1.2em; text-align: left;">
    ...
    <!-- <br><br> Veja abaixo nossa lista de projetos, em breve mais informações sobre cada um deles.<br><br>

	 <div style="text-align: left; width: 50%; position: absolute; right: 25%;">
	 <i class="fa fa-check-square fa-1x"></i> Ação social nas Casas Lares Bethel.<br>
	 <i class="fa fa-check-square fa-1x"></i> Escola Preparatória para Futuros Cientistas<br>
	 <i class="fa fa-check-square fa-1x"></i> Encontro Regional de Futuros Cientistas.<br>
	 <i class="fa fa-check-square fa-1x"></i> Concurso de Contos<br>
	 <i class="fa fa-check-square fa-1x"></i> Maratona do Conhecimento<br>
	 <i class="fa fa-check-square fa-1x"></i> Cursinho Talentos do Futuro (parceria com o Curso e Col&eacute;gio Objetivo de Sorocaba).<br>
	 <i class="fa fa-check-square fa-1x"></i> Ciência em três minutos. Confecção de vídeos curtos e didáticos sobre ciências.<br>
	 <i class="fa fa-check-square fa-1x"></i> EAD - Aprendizado pela descoberta (em desenvolvimento). <br>
	 </div>
		  -->
